...
public class Camera
{
    ...
    public void centerOnPlayer(World world, Player player)
    {
        ...
        // Place vertically such that the player is (72+36) pixels from the bottom
        // of the screen, noting that panel has been added to the screen.
        double top = player.getY() - (double) (Game.playheight() - 72 - 36);
        moveto(left, top);
    }
